...
## 🤔 Is it difficult to use MHS-CBAU for my simulations ?
...
## ✅ Detailed checklist for a quick parametrisation
...
> 💡 You can use the folder `/speciesCheckTest` in this repository to check if all of your species are represented in the four files given above. Just put a .csv file where the first column contains the name of the species you are simulating in LANDIS, and run the python script in this folder using the command `python speciesCheckTest.py` from a terminal pointing to this folder. The script will analyse your species and indicate which of them might be missing from these four files.
...
🎉🎊 **And with that, you're done !** Now, MHS-CBAU should work properly during your simulation. If it doesn't, please post in the [issues section](https://github.com/Klemet/MHS-CBAU/issues) of this repository.
