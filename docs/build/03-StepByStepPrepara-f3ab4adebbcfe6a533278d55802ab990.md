...
The scripts will output a file named `annualHarvestTargets.json`. Here is what it will look like. Keep this file at hand. Keep in mid the units used in it : the main MHS-CBAU python script is adapted to used these units.
