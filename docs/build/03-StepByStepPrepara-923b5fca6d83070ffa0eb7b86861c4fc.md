...
- Another quick word on the timeframe of the Business As Usual; when we define a Business as Usual scenario for a given landscape, we have to define what time period do we mean for the "as usual". Is it the last 5 years ? The last 10 years ? The last 20 years ? 30 years ? etc. Thing is, Canadian forest management has changed in the past 30 years. Through social pressure and economic crisis, the wood volume harvested in the different provinces have Canada have really changed through time. Based on the data available and on my own knowledge of these changes, the year 2000 to 2020 represents a pretty good fit. Harvesting in Canada was higher between 2000-2005 than it is today (it dropped at around 2008), but as the legacy of this more intense harvesting is still here, and because there's always a risk that we come back to these levels in the future, I'd say that this is a pretty good "Business As Usual" timeframe for Canada.
