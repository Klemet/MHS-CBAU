...
I would have liked to find a better solution, but it seemed to be the best choice to go with. Ultimatly, the approach that will result is stable, replicable, and sharable (by sharing your input files), ensuring that it remain compatible with 
:::
