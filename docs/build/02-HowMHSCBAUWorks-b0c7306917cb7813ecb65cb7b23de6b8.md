...
## The python scripts used by MHS-CBAU during the LANDIS-II simulation
...
Both scripts are heavily commented, explaining everything step-by-step. So if you need to understand something, you can read the scripts; even if you don't know Python, you will learn a lot.
