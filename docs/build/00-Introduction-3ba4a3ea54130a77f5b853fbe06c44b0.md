...
This small website contains a workshop to help you use [MHS-CBAU](https://github.com/Klemet/MHS-CBAU). MHS-CBAU is a step of scripts designed to help you replicate a *Business as Usual* forest management in a Canadian landscape simulated with the [LANDIS-II]() model. It's simply an implementation of the powerpoint presentation I did in the summer of 2025 at the University of Toronto. You'll have both the slides and the text of the slides in a readable format.
