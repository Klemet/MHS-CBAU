...
Functions through a very documented Python script that can be edited to do other management scenarios : TRIAD zoning, Functional Complex Network, Climate Smart Forestry, etc. Python is a pretty easy langage to learn and can be used in a terminal, just like R !

Customizing the scripts will take some time, of course. It is programming. But Python makes it easier to do because you can run the script in Spyder (the equivalent of R studio, but for Python) to test them and de-bug them.
