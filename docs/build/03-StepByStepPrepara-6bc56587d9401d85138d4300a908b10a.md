...
The scripts are located in `scriptsToGenerateInputs/4.MerchantableBiomassDictionnary`. You will find a README.txt file containing all of the instructions you will need to run the scripts.
