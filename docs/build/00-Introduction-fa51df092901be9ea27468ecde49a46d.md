...
Dealing with merchantable wood, in particular, makes it easier to parameterize and to communicate with our partners - they are foresters, their main unit of profit is merchantable wood volume (and not biomass, which is what LANDIS-II uses, and which is more used by ecologists).
