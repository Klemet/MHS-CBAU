...
If it's not done already, I recommand you take the time to properly install Python on your computer. This will be a time-saver. Check [the bonus section about installing Python](./05-BonusPythonInstall).
:::
...
If you don't have Spyder installed on your computer yet, please check [the bonus section about installing Python](./05-BonusPythonInstall).
:::
