...
Biomass Harvest have been develloped for a long time in LANDIS-II, and uses a complex system of "support libraries" (libraries of functions used in the code of LANDIS-II).
:::
