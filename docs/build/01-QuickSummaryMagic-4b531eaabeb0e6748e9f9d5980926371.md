...
But the harvesting still has to ultimatly go through the complex system of support libraries for harvesting so that is is done during the simulation. Because of this, it was much easier to use Magic Harvest to control Biomass Harvest (which was already made to communicate with these support libraries) rather connecting Magic Harvest to them (which might have reduced the flexibility offered by Magic Harvest).
