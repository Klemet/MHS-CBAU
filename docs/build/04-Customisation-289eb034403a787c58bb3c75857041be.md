...
- When you will want to include harvesting in your LANDIS-II simulation, check the repository for the step-by-step checklist to prepare all of the files for a Business As Usual scenario
